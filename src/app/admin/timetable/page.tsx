  ...
  return (
    <div className="space-y-6 fade-in">
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
        <div>
          <div className="section-title">Timetable management · Admin</div>
          <h1 className="mt-1 text-2xl font-bold tracking-tight text-slate-900">
            Master timetables
          </h1>
          <p className="mt-1 text-sm text-slate-600">
            Full control across every department, semester and section.
          </p>
        </div>
        <button
      ...
      <div className="card overflow-hidden">
        <div className="border-b border-slate-200 bg-slate-50 p-4">
          <div className="text-sm font-semibold text-slate-900">
            {day.charAt(0).toUpperCase() + day.slice(1)} · {department} · Sem{" "}
            {semester} · Sec {section}
          </div>
        ...
        {loading ? (
          ...
          <div className="p-12 text-center">
            ...
            <div className="mt-3 text-sm font-semibold text-slate-900">
              No slots for this combination
            </div>
            <p className="mt-1 text-xs text-slate-500">
              Add slots or pick a different department/semester/section/day.
            </p>
          </div>
        ) : (
